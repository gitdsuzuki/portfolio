  ...
  form.addEventListener('submit', async function (e) {
    ...
    try {
      ...
      if (json.status === 'ok') {
        ...
        statusEl.innerHTML = '確認メールを送信しましたのでご確認ください。<br>通常1営業日以内にご返信いたします。<br><span class="text-xs text-green-600 mt-1 block">※ メールが届かない場合は、メールアドレスが正しいかご確認のうえ、迷惑メールフォルダもご確認ください。</span>';
        form.reset();
      } else {
